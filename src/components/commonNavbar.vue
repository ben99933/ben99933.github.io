<template>
<ul class="navbar-list  justify-start items-start">
    <li class="navbar-item" v-for="item in commonNavbarItems" :key="item.name">
        <a :href="item.link">
            <button class="navbar-link hover:text-blue-500" data-nav-link>
                {{item.name}}
            </button>   
        </a>
